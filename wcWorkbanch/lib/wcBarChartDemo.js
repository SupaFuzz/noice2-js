...
class wcBarChartDemo extends wcScreen {




static classID = wcBarChartDemo;
...
constructor(args){
    // boilerplate
    super(args);
    this._className = 'wcBarChartDemo';    // change me
    this._version = 1;
...
*/
getAttributeDefaults(){ return(wcBarChartDemo.classAttributeDefaults); }
getStyleDefaults(){ return(wcBarChartDemo.classStyleDefaults); }
    ...
    this.content = `
        ...
        <div class="container">
            <div class="header" data-_name="header">
                <h2 class="title">wcBarChart Demo</h2>
            </div>
...
const _classRegistration = wcBarChartDemo.registerElement('wc-bar-chart-demo');
export { _classRegistration as wcBarChartDemo };
