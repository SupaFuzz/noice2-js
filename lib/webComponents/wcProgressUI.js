...
static classAttributeDefaults = {
    ...
    static_width: { observed: true, accessor: true, type: 'bool', value: false, forceAttribute: true },
};
...
static classStyleDefaults = {
    ...
    'static-width': { value: '66vw', global: true },
    'message-font-size': { value: '.85em', global: true },
    'message-font-family': { value: 'inherit', global: true }
}
...
get defaultStyle(){return(`
    ...
    :host([static_width="true"]) div.wcProgressUI {
        width: ${this.styleVar('static-width')};
    }
    div.wcProgressUI {
        display: grid;
    ...
    div[data-_name="message"] {
        ...
        font-size: ${this.styleVar('message-font-size')};
        font-family: ${this.styleVar('message-font-family')};
    }
