...
set element(el){ if (el instanceof noiceAutonomousCustomElement){
    ...
    el.addEventListener('initialized', (evt) => { if (that.initializedCallback instanceof Function){ that.initializedCallback(evt); } });
