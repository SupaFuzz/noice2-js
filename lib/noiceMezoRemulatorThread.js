...
/*
    ...
    leaving this here, BRB -- gotta go make a new object attribute to hold it

    api.getOpenAPI(schema: 'remulator').catch((error) => {
        // error is nonfatal, just log it
        that.log(`updateFormDefinitions('openAPI') | (non-fatal) failed to pull remulator openAPI interface description: ${error}`);
    }).then((ifDesc) => {
